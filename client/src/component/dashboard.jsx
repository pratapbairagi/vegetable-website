...
const Dashboard = () => {
    const [tabList, setTabList] = useState([
        {
            label: "Dashboard",
            icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="w-4 sm:w-5 md:w-6 lg:w-7 xl:w-8">
        ...
        {
            label: "Orders",
            icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-3 sm:w-4 md:w-5 lg:w-6 xl:w-7">
        ...
        {
            label: "Users",
            icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="w-4 sm:w-5 md:w-6 lg:w-7 xl:w-8">
        ...
        {
            label: "Admins",
            icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 sm:w-5 md:w-6 lg:w-7 xl:w-8">
        ...
        <div className=" bg-gray-100 w-full max-w-screen z-30 top-0 left-0 overflow-y-hidden max-h-screen min-h-screen h-max min-h-screen">
            ...
            <div className="w-full grid grid-cols-12">
                <div className="w-full scroll-overflow-hidden overflow-x-auto md:overflow-x-hidden md:col-span-4 lg:col-span-4 xl:col-span-3 h-max md:h-full bg-white fixed  md:sticky bottom-0 left-0 md:bottom-initial md:top-0 order-2 md:order-1">
                    <h4 className="w-full hidden md:flex text-3xl font-extrabold font-nunito text-theme-blue-600 md:px-14 lg:px-14 xl:px-16 md:py-4 lg:py-5 xl:py-6">Website</h4>
                    <ul className="flex relative flex-row md:flex-col gap-y-4 md:mt-6  md:px-4 md:px-12">
                ...
                <div className="col-span-12 overflow-x-hidden overflow-y-auto h-screen max-h-screen md:col-span-8 lg:col-span-8 xl:col-span-9 order-1 md:order-2">
                    <div className="col-span-12 flex items-center py-1 bg-white px-2 md:px-2 lg:px-3 sticky top-0">
