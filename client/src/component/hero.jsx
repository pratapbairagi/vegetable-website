        ...
        <div className="w-full max-w-[100%] overflow-x-auto relative">
            ...
            return <div key={i} className={`pb-4 md:pt-[7vh] lg:pt-[9vh] md:h-50vh min-h-[40vh] lg:min-h-[70vh] w-full grid grid-cols-12 relative min-w-[100%] ${v.active ? "block" : "hidden"}`} >
                 ...
                 <div className="py-10 sm:py-10 md:py-8 lg:py-6 xl-py-0 pr-4 sm:pr-6 md:pr-3 pl-6 sm:pl-8 md:pl-8 lg:pl-12 xl:pl-16 col-span-12 sm:col-span-12 md:col-span-7 lg:col-span-7 xl:col-span-7 h-full flex flex-col justify-center relative z-10">
                     <h6 className="text-xl sm:text-xl md:text-2xl lg:text-3xl font-extrabold font-nunito text-gray-100">Baazar for</h6>
                     <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold mt-0.5 md:mt-1 lg:mt-1.5 xl:mt-2 font-nunito text-gray-100 capitalize">Fresh {v.name}</h1>

                     <p className="text-base sm:text-base md:text-base lg:text-xl xl:text-2xl mt-4 sm:mt-4.5 md:mt-5.5 lg:mt-6 xl:mt-6.5 leading-normal text-gray-100 font--nunito">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus sequi temporibus aliquid maiores eius, ipsam, ducimus, itaque alias voluptas excepturi et cum eveniet quibusdam architecto.</p>

                     <button className="text-sm sm:text-base md:text-lg font-bold px-2 sm-px-2 md:px-3 py-1 sm:py-1 md:py-1.5 bg-theme-blue-600 w-max mt-10 sm:mt-10 md:mt-10 lg:mt-10 xl:mt-12 rounded text-gray-100 font-nunito cursor-pointer z-10">Find More</button>
                 </div>
