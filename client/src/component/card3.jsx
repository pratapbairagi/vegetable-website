...
const Card3 = ({style}) => {
    return (
        <div className="card col-span-6 sm:col-span-5 md:col-span-5 lg:col-span-4 xl:col-span-3 h-full min-h-30vh min-w-44 sm:min-w-44 md:min-w-48 lg:min-w-56 xl:min-w-60 flex flex-col py-2" style={style}>
            ...
            <button className="text-3xs sm:text-3xs md:text-2xs lg:text-xs xl:text-sm font-semibold text-theme-blue-600  px-1.5 sm:px-1.5 md:px-2.5 lg:px-3.5 xl:px-4 py-1 sm:py-1 md:py-1.5 lg:py-2 xl:py-2.5 rounded-sm hover:bg-white hover:border-transparent  mt-4 mx-auto border" style={{ width: "94%" }}>ADD TO CART</button>
