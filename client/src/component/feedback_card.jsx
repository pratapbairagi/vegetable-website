...
const Feedback_card = () => {
    return (
        <div className="min-w-full min-h-full sm:min-w-80% md:min-w-70% lg:min-w-50% flex flex-col">
                    <div className="grid grid-cols-12 w-full">
                        ...
                        <p className="col-span-4 flex items-end pb-5 text-xl md:text-3xl font-bold font-nunito text-theme-green-600">Freshness</p>
                        <div className="flex col-span-4 items-end justify-center pb-6 ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}  className="w-5 md:w-7 stroke-theme-blue-600">
                    ...
                    <p className="w-full text-xs md:text-xl px-3 mt-4 text-gray-400 text-nunito" style={{lineHeight:"170%"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus temporibus voluptates magni ipsum quibusdam. Consequatur veniam fugit sapiente totam suscipit?</p>
