...
const Contact = () => {
    return (
        <div className="w-full h-max py-8 sm:py-10 md:py-12 lg:py-14 xl:py-16" >
            ...
            <div className="grid grid-cols-12 w-full mt-10 lg:mt-16 gap-y-10 lg:gap-y-16" >
                ...
                <div className="grid grid-cols-12 gap-y-8 px-5 gap-x-0 lg:gap-x-8 xl:gap-x-10 col-span-12 lg:col-span-6">
                    ...
                    <form className="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 grid gird-cols-12 gap-y-2.5 ">
                        <fieldset className="flex flex-col lg:max-w-60%">
                    ...
                    <div className="grid grid-cols-12 gap-y-8 px-5 gap-x-0 lg:gap-x-8 xl:gap-x-10 ">
                        ...
                        <div className="order-2 lg:order-1 col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 flex flex-col gap-y-4 md:gap-y-6 xl:h-full">
                            ...
                            <div className="w-full flex flex-col gap-y-0.5">
                                <span className="text-base md:text-xl font-bold font-nunito text-gray-300">Contact No.</span>
                                <div className="text-xl md:text-2xl font-bold font-nunito text-gray-400">+91 8287889123</div>
                            </div>

                            <div className="w-full flex flex-col gap-y-0.5">
                                <span className="text-base md:text-xl font-bold font-nunito text-gray-300">Email</span>
                                <div className="text-xl md:text-2xl font-bold font-nunito text-gray-400">pratapbairagi@gmail.com</div>
                            </div>

                            <div className="w-full flex flex-col gap-y-0.5">
                                <span className="text-base md:text-xl font-bold font-nunito text-gray-300">Address</span>
                                <div className="text-xl md:text-2xl font-semibold font-nunito text-gray-400">RZ-170/1A, Tughlakabad Extn. South Delhi, Delhi - 110019.</div>
                            </div>
