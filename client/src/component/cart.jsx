        ...
        <div className={`w-full fixed h-screen bg-white z-30 top-0 px-3 transition-all duration-200`} style={{left:`${toggleCart ? "0" : "-100%"} `}}>
            ...
            <div className="grid grid-cols-12 lg:gap-x-10">
                ...
                <div className="col-span-12 lg:col-span-4 flex flex-col mt-4 lg:mt-6 lg:mx-4">
                    ...
                    <div className="grid grid-cols-12 mt-1 ">
                        <span className="col-span-9 flex justify-start text-xs lg:text-sm text-gray-600 font-normal font-nunito text-theme-green-600 py-1.5">You will save 50 on this order</span>
