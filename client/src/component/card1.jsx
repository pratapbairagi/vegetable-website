...
const Card1 = ({title, price, images, ratings, description}) => {
    console.log(images)
    return (
        <>
            <div className="card col-span-6 sm:col-span-6 md:col-span-4 lg:col-span-4 xl:col-span-3  flex flex-col p-1 border-r">
                ...
                <div className="w-full h-max grid grid-cols-12 px-2 sm:px-2 md:px-3 lg:px-4 xl:px-5">
                    ...
                    <NavLink to={`/vegetable/${title}`} className="col-span-12 text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-extrabold font-nunito text-theme-blue-600 mt-4 sm:mt-4 md:mt-5 lg:mt-6 xl:mt-7 cursor-pointer">{title}</NavLink>
                    <p className="col-span-12 text-sm sm:text-sm md:text-base lg:text-xl xl:text-2xl text-gray-400 font-nunito mt-1 sm:mt-1 md:mt-2 lg:mt-3 xl:mt-4 line-clamp-3">{description}</p>
