...
import { user_login } from "../redux/user/action";
        ...
        <div className={`w-full  h-screen z-30 top-0 bg-white block fixed`}>
            ...
            <div className="grid grid-cols-12 relative h-full relative">
                ...
                <div className="col-span-12 md:col-span-6 max-h-60vh md:max-h-full flex flex-col md:justify-center items-center">
                    ...
                    <form onSubmit={submitLoginForm} className="flex flex-col md:justify-center gap-y-2 md:gap-y-4 mt-4 md:max-w-90% lg:max-w-96 relative">
                        <fieldset className="flex flex-col">
                            <label htmlFor="email" className="text-base text-gray-400">Email</label>
                            <input onChange={userInputHandler} type="email" name="email" className="border text-sm py-2 px-2" placeholder="Ex: johnn@gmail.com" />
                        </fieldset>

                        <fieldset className="flex flex-col">
                            <label htmlFor="password" className="text-base text-gray-400">Password</label>
                            <input id="password" onChange={userInputHandler} type="password" name="password" className="border text-sm py-2 px-2" placeholder="Ex: Abcd1@" />
                        ...
                        <fieldset className="grid grid-cols-12 mt-4">
                            <button type="submit" className="bg-theme-blue-600 text-gray-100 py-1.5 col-span-12">Login</button>
