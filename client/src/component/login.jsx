...
const Login = ({ loginToggle, setLoginToggle }) => {
    return (
        <div className={`w-full  h-screen fixed z-30 top-0 bg-white ${loginToggle ? "block" : "hidden"}`}>

            <div className="grid grid-cols-12 relative h-full relative">
                <button onClick={()=> setLoginToggle(false)} className="absolute z-40 right-3 top-5 ">
